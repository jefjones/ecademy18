...
import { selectMe, selectUsers, selectBehaviorIncidentTypes, selectBehaviorIncidentResponseTypes, selectStudents, selectBehaviorIncidents,
 					selectAccessRoles, selectMyFrequentPlaces} from '../store'
...
function Container(ownProps) {
  ...
  useEffect(() => {
            ...
            props.location && props.location.pathname && setMyVisitedPage(personId, {path: props.location.pathname, description: `Add Behavior Incident`})
        
  }, [])

  return <BehaviorIncidentAddView {...props} />
}
