...
import { selectMe, selectMyFrequentPlaces, selectCarpool, selectCompanyConfig, selectMessageFullThread, selectFetchingRecord } from '../store'
...
function Container(ownProps) {
  ...
  useEffect(() => {
            ...
            const {getPageLangs, langCode, carpoolInit, personId} = props
            getPageLangs(personId, langCode, 'CarpoolView')
            carpoolInit(personId)
        
  }, [])

  return <CarpoolView {...props} />
}
