...
import { selectMe, selectRegistration, selectUSStates, selectCountries, selectPaymentProcessingResponse, selectCompanyConfig } from '../store.js';
...
class Container extends Component {
		componentDidMount() {
				const {getPageLangs, langCode, personId, setMyVisitedPage, getCountries, getUSStates} = this.props;
	  ...
	  render() {
	    	return <RegBillingPreferenceView {...this.props} />;
	  }
}
