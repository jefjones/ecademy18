...
function MainMenuPenspring(props) {
  ...
  const {workSummary, groupSummary, personId, setWorkCurrentSelected, personName, editorScore, deleteWork, deleteChapter,
                  ...
                  deleteInvite, acceptInvite, resendInvite} = props
          
  
          return (
              <div className={styles.container}>
                  <input type="checkbox" className={styles.check} id="checked" checked={opened} ref={(ref) => (dropdown = ref)}/>
                  <label className={styles.menuBtn}  ref={(ref) => (menuThing = ref)}>
...
export default MainMenuPenspring
