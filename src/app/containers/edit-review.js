...
import * as fromEditReview from '../reducers/EditReview/edit-review.js';
import * as actionTranslatedSentence from '../actions/translated-sentence.js';
import * as actionLeftSidePanel from '../actions/left-side-panel.js';
import * as actionPersonConfig from '../actions/person-config.js';
import * as actionEditMicroReplace from '../actions/edit-micro-replace.js';
...
import * as actionDraftComparison from '../actions/draft-comparison.js';
import * as actionTextProcessingProgress from '../actions/text-processing-progress.js';
import * as actionFetchingRecord from '../actions/fetching-record.js';
import * as actionPageLang from '../actions/language-list';
//import {wait} from '../utils/wait.js';
import {guidEmpty} from '../utils/GuidValidate.js';
//import * as actionGradebook from '../actions/grade-book.js';  part of the score function that isn't working due to the cursor location management or EditorDiv.
...
import { selectMe, selectWorkEditReview, selectLeftSidePanelOpen, selectPersonConfig, selectEditMicroReplace, assignColorsEditor, selectTextProcessingProgress,
					selectEditReview, selectEditDetails, selectLanguageIdCurrent, selectFetchingRecord, selectLanguageList} from '../store.js';
...
class Container extends Component {
    ...
    componentDidMount() {
        const {personId, workId, getWorkEditReview, workSummary, params, languageId, getEditDetails, setBookmarks, setDraftComparison, getChapterText,
                  getAuthorWorkspace, setEditorTabChosen, getPageLangs, langCode} = this.props;
    ...
    // componentDidUpdate() {
    //     const {isLMSTransfer, fetchingRecord, workSummary, resolveFetchingRecordWorkEditReview, getWorkEditReview, personId, workId} = this.props;
		// 		if (isLMSTransfer && (!workSummary || !workSummary.authorPersonId)) getWorkEditReview(personId, workId);
    //     // if (fetchingRecord && !fetchingRecord.workEditReview && workSummary && workSummary.authorPersonId) {
    //     //     resolveFetchingRecordWorkEditReview();
    //     // }
    // }

    render() {
				const {workId, workSummary, fetchingRecord} = this.props;
