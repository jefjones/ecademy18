...
import * as actionMessageSave from '../actions/message-save.js'
import * as actionMessageGroups from '../actions/message-groups.js'
...
import { selectStudents, selectUsers, selectMe, selectAnnouncementList, selectCompanyConfig, selectAccessRoles, selectGuardians, selectAnnouncementAttachments,
          selectGradeLevels, selectMessageSave, selectCoursesScheduled, selectMessageGroups, selectMyFrequentPlaces, selectStudentCourseAssigns} from '../store.js'
...
class Container extends Component {
	  componentDidMount() {
		    const {getPageLangs, langCode, getAnnouncementsRecipient, setMyVisitedPage, personId, editType, getAnnouncementAttachments, announcementId, getMessageGroups, getGradeLevels,
								getGuardians, getStudentCoursesAssignsByTeacher} = this.props
        ...
        this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Message`})
	  }

	  render() {
	     return <AnnouncementEditView {...this.props} />
	  }
}
