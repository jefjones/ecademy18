...
import * as actionSaveStudentSearch from '../actions/saved-student-search'
...
import { 	selectUsers, selectStudents, selectMe, selectLearnerFilter, selectCompanyConfig, selectAccessRoles, selectCoursesScheduled,
					selectGradeLevels, selectGuardians, selectFetchingRecord, selectUserPersonClipboard, selectSavedStudentSearch, selectPersonConfig,
				 	selectSchoolYears, selectMyFrequentPlaces, selectStudentCourseAssigns} from '../store'
...
function Container(ownProps) {
  ...
  useEffect(() => {
    				...
    				const {getPageLangs, langCode, personId, setMyVisitedPage, getSavedStudentSearch, getGuardians, getGradeLevels, getUserPersonClipboard} = props
    				...
    				props.location && props.location.pathname && setMyVisitedPage(personId, {path: props.location.pathname, description: `Search for Student (Advanced)`})
    		
  }, [])

  return <LearnerSearchView {...props} />
}
