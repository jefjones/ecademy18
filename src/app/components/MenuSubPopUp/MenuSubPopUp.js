...
export default class MenuSubPopUp extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.launchButton.addEventListener("click", this.handleDisplay);
    ...
    componentWillUnmount() {
        ...
        const {personConfig, updatePersonConfig, personId, keepHistoryOn, keepAutoNextOn, keepEditDifferenceOn} = this.props;
    ...
    render() {
        let {personId, updatePersonConfig, personConfig, toggleKeepHistoryOn, toggleKeepAutoNextOn, toggleKeepEditDifferenceOn,
            keepHistoryOn, keepAutoNextOn, keepEditDifferenceOn } = this.props;
        const {opened} = this.state;

        return (
            <div className={styles.container}>
                <div className={styles.launchButton} ref={(ref) => (this.launchButton = ref)}>
