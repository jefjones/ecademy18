...
import { selectMe, selectRegistration, selectUSStates, selectCountries, selectPaymentProcessingResponse, selectCompanyConfig, selectProxynizationTempPassword } from '../store'
...
function Container(ownProps) {
  ...
  useEffect(() => {
    				...
    				const {getPageLangs, langCode, personId, setMyVisitedPage, getCountries, getUSStates, getProxynizationTempPassword} = props
  ...
  return <RegBillingPreferenceViewSimple {...props} />
}
