...
import { selectMe, selectWorkFilter, selectFetchingRecord, selectGroups } from '../store.js';
...
class Container extends Component {
  componentDidMount() {
      const {getPageLangs, langCode, groupInit, workFilterInit, personId} = this.props;
