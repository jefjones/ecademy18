...
import styles from './LearnerOutcomeModal.css';
import {ModalContainer, ModalDialog} from '../react-modal-dialog/lib/index.js';
import EditTable from '../EditTable';
import ButtonWithIcon from '../ButtonWithIcon';


export default class LearnerOutcomeModal extends Component {

    render() {
        const {handleClose, okText='OK', ratingName, learnerFullName, learnerOutcomes, outcomeList} = this.props;
