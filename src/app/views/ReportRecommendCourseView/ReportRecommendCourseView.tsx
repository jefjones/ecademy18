...
function ReportRecommendCourseView(props) {
  const {reportRecommendCourseName, reportRecommendByTeacher, reportRecommendByStudent} = props
...
export default ReportRecommendCourseView
