...
import * as actionAdmins from '../actions/admins.js';
import * as loginUser from '../actions/login.js';
import { selectMe, selectUsers, selectCompanyConfig, selectAccessRoles, selectGradeLevels } from '../store.js';
...
class Container extends Component {
    ...
    render() {
        return <AdminAddView {...this.props} />
    }
}
