...
import * as fromEditReview from './edit-review.js';
import * as fileTreeSubContents from './file-tree-sub-contents.js';
import * as fromGroups from './groups.js';
    ...
    return dispatch => {
        ...
        .then(response => {
            ...
            if (includeAssignmentWorkId && includeAssignmentWorkId !== guid.emptyGuid()) {
                ...
                browserHistory.push(`/editReview/${includeAssignmentWorkId}`);
            }
        })
