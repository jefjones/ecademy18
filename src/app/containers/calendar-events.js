...
import { selectMe, selectMyFrequentPlaces, selectCalendarEvents, selectAccessRoles, selectCompanyConfig, selectMyProfile,
					selectPersonConfigCalendar, selectUsers, selectStudents, selectCoursesScheduled, selectStudentCourseAssigns} from '../store.js';
...
class Container extends Component {
    componentDidMount() {
				const {getPageLangs, langCode, personId, setMyVisitedPage, getCalendarEvents, getPersonConfigCalendar} = this.props;
				...
				this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Calendar and events`});
    }

    render() {
        return <CalendarAndEventsView {...this.props} />;
    }
}
