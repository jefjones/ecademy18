...
export default class AssessmentTrueFalse extends Component {
  constructor(props) {
    super(props);
    this.state = {}
  }

  sendAssessmentAnswer = (value, personId) => {
    const {onClick, question, assignmentId} = this.props;
    ...
    return (
      <div className={classes(className, styles.container)}>
        ...
        <RadioGroup
          ...
          personId={personId}
          onClick={onClick ? this.sendAssessmentAnswer : () => {
          }}/>
