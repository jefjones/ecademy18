...
import { selectLearnerOutcomes, selectLearningPathways, selectLearningFocusAreas, selectUsers, selectLearnerOutcomeTargets,
          selectLearners, selectMe, selectLearnerFilter, selectMentorsAssigned, selectCompanyConfig } from '../store.js';
...
class Container extends Component {
    componentDidMount() {
        const {getPageLangs, langCode, setMyVisitedPage, getAllLearnersMentors, learnersInit, learnerFilterInit, personId} = this.props;
        ...
        this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Mentor Reassign`});
    }

    render() {
        return <LearnerMentorReassignView {...this.props} />;
    }
}
