...
import * as actionFocusAreas from '../actions/learning-focus-areas.js';
...
import { selectLearningPathways, selectLearningFocusAreas, selectCourseTypes, selectMe, selectCoursesBase, selectCompanyConfig, selectGradeLevels,
					selectFetchingRecord, selectMyFrequentPlaces, selectCoursePrerequisites, selectStandardsRating } from '../store.js';
...
class Container extends Component {
	  componentDidMount() {
		    const {getPageLangs, langCode, personId, setMyVisitedPage, getLearningPathways, getFocusAreas, getStandardsRating} = this.props;
		    ...
		    getLearningPathways(personId);
				...
				this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Course Entry`});
	  }

	  render() {
	    const {fetchingRecord, learningPathways} = this.props;
	    return <CourseEntryView {...this.props} />
