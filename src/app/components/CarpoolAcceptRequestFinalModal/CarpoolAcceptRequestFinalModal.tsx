...
function CarpoolAcceptRequestFinalModal(props) {
  const [seatsAvailable, setSeatsAvailable] = useState('')
  const [seatsNeeded, setSeatsNeeded] = useState('')
  const [errorSeats, setErrorSeats] = useState('')

  const {handleClose, carpoolRequestResponse, daysOfWeekAll} = props
...
export default CarpoolAcceptRequestFinalModal
