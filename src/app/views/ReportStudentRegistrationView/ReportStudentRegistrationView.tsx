...
function ReportStudentRegistrationView(props) {
  const {reportStudentRegistration, reportCourseSeatStatus, reportStudentCourseAssign} = props
...
export default ReportStudentRegistrationView
