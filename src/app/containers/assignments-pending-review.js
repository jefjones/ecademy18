...
import { selectMe, selectMyFrequentPlaces, selectFetchingRecord, selectAssignmentsPendingReview, selectCompanyConfig, selectCourseTypes,
 					selectContentTypes, selectAccessRoles} from '../store.js';
...
class Container extends Component {
  componentDidMount() {
      const {getPageLangs, langCode, personId, setMyVisitedPage, path, getAssignmentsPendingReview, getContentTypes, getCourseTypes} = this.props;
  ...
  render() {
    return <AssignmentsPendingReviewView {...this.props} />;
	}
}
