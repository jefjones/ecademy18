...
function Container(ownProps) {
  ...
  useEffect(() => {
            ...
            const {getPageLangs, langCode, personId, getTeacherSchedule, facilitatorPersonId, getIntervals} = props
  ...
  useEffect(() => {
    				...
    				const {personId, setMyVisitedPage, getTeacherSchedule, facilitatorPersonId, teacherSchedule, facilitators} = props
    				...
    				if (teacherSchedule && teacherSchedule.firstName && (!isInit || facilitatorPersonId !== state.facilitatorPersonId)) {
    						getTeacherSchedule(personId, facilitatorPersonId)
    						props.location && props.location.pathname && setMyVisitedPage(personId, {path: props.location.pathname, description: `Teacher Schedule: ${teacherName}`})
    						setIsInit(true); setFacilitatorPersonId(facilitatorPersonId)
    				}
