...
//First Nav actions:
import * as actionGradeReport from '../actions/grade-report.js';
import * as actionAccessRoles from '../actions/access-roles.js';
import * as actionCourseEntry from '../actions/course-entry.js';
...
import * as actionRegistration from '../actions/registration.js';
import * as actionRegistrationPending from '../actions/registration-pending.js';
import * as actionRegStudent from '../actions/reg-student.js';
import * as actionGuardianContact from '../actions/reg-guardian-contact.js';
...
import * as assignmentsPendingReview from '../actions/assignments-pending-review.js';
import * as actionObservers from '../actions/observers.js';
...
import * as actionAssignments from '../actions/assignment-list.js';
...
import * as actionRegBillingPreference from '../actions/reg-billing-preference.js';
...
import * as actionPersonConfigCalendar from '../actions/person-config-calendar.js';
import * as actionCalendarEvents from '../actions/calendar-events.js';
...
import { selectMe, selectFetchingRecord, selectPersonConfig, selectCoursesBase, selectStudents, selectUsers, selectCalendarEvents,
					  ...
					  selectAdminResponsePendings, selectMyFrequentPlaces, selectMyVisitedPages, selectPersonConfigCalendar, selectTutorialVideos,
						...
						selectWorkSummaryCurrent, selectGroupIdCurrent, selectGroups, selectEditorInvitePending } from '../store.js';
...
class App extends Component {
	 constructor(props) {
	  ...
	  render() {
				const {accessRoles, pageLangs} = this.props;
				return accessRoles
