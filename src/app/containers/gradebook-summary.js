...
import { selectMe, selectStudents, selectCoursesScheduled, selectCompanyConfig, selectGradebookSummary, selectPersonConfig,
					selectAccessRoles, selectFetchingRecord, selectMyFrequentPlaces} from '../store.js';
...
class Container extends Component {
		componentDidMount() {
				...
				this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Gradebook Summary`});
		}

    render() {
        return <GradebookSummaryView {...this.props} />;
    }
}
