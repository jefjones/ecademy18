...
import * as actionBechmarkTests from '../actions/benchmark-tests.js';
...
class Container extends Component {
	...
	componentDidMount() {
      const {getPageLangs, langCode, personId, getStandards, getCourseWeightedScore, courseEntryId, getContentTypes, getCourseTypes, getCoursesBase, setMyVisitedPage, getBenchmarkTests,
							getStudentCoursesAssignsByBase} = this.props;
			...
			this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Assignment Entry`});
	}

  render() {
    return <AssignmentEntryView {...this.props} />;
	}
}
