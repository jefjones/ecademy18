export const formatDayShortMonthYear = (dateText, hasDashes=false) => {
    ...
    const monthIndex = newDate.getMonth(); //Notice that the monthNames array, in this case, starts in index 0 which matches with getMonth which is also zero based..
