...
import { selectMe, selectMyFrequentPlaces, selectUsers, selectCompanyConfig, selectAccessRoles, selectPersonConfig } from '../store'
...
function Container(ownProps) {
  ...
  useEffect(() => {
    	      ...
    	      props.location && props.location.pathname && setMyVisitedPage(personId, {path: props.location.pathname, description: `Add User`})
    	  
  }, [])

  return <UserAddView {...props} />
}
