...
import * as courses from '../actions/course-to-schedule.js';
import * as courseEntry from '../actions/course-entry.js';
import * as openRegistrations from '../actions/open-registrations.js';
import * as guardians from '../actions/guardians.js';
import * as mapDirections from '../actions/map-directions.js';
import * as safetyAlertTypes from '../actions/safety-alert-types.js';
import * as volunteerTypes from '../actions/volunteer-types.js';
import * as volunteerEvents from '../actions/volunteer-event.js';
import * as adminResponsePendings from '../actions/admin-response-pendings.js';
import * as behaviorIncidentTypes from '../actions/behavior-incident-types.js';
import * as colleges from '../actions/colleges.js';
import * as doctors from '../actions/doctors.js';

import * as courseRecommendation from '../actions/course-recommendation.js';
import * as gradRequirements from '../actions/grad-requirements.js';
import * as coursePrerequisites from '../actions/course-prerequisites.js';
import * as courseTypes from '../actions/course-types.js';
import * as classPeriods from '../actions/class-periods.js';
import * as learningPathways from '../actions/learning-pathways.js';
import * as department from '../actions/department.js';
...
import * as duenos from '../actions/duenos.js';
import * as myFrequentPlaces from '../actions/my-frequent-places.js';
import * as myVisitedPages from '../actions/my-visited-pages.js';
import * as personConfigCalendar from '../actions/person-config-calendar.js';
import * as calendarEvents from '../actions/calendar-events.js';
import * as lang from '../actions/language-list.js';
import * as schoolYears from '../actions/school-years.js';

import * as myProfile from '../actions/my-profile.js';
    ...
    fetch(`${apiHost}ebi/person/forgotPassword/` + username + `/` + phone, {
      ...
      .then(response => {
        if (response.result === "GOTORESETPASSWORD" || salta === 'salta') {
          ...
          browserHistory.push('/initStudentLogin/' + response.personId)
        } else {
    ...
    fetch(`${apiHost}ebi/person/initialPassword/` + newLoginPersonId, {
      ...
      .then(response => {
        ...
        response && response.hasInitialPassword
          ? browserHistory.push(`/initStudentLogin/${newLoginPersonId}/${response.username}`)
...
export function initRecords(response, sendTo) {
  return dispatch => {
    ...
    sendTo && browserHistory.push(sendTo);
  }
}
