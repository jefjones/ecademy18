...
export default class LunchReducedInstructionsView extends Component {
  constructor(props) {
    super(props);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={classes(globalStyles.centered, styles.moreTop, styles.row)}>
                <ButtonWithIcon label={'Close'} icon={'checkmark_circle'} onClick={() => browserHistory.push(`/firstNav`)}/>
                <ButtonWithIcon label={'Next >'} icon={'checkmark_circle'} onClick={() => browserHistory.push(`/lunchReducedApply`)}/>
            </div>
            <OneFJefFooter />
      </div>
    );
