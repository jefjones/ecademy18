...
import * as actionFileTreeSubContents from '../actions/file-tree-sub-contents.js';
...
import { selectMe, selectWorkFilter, selectWorkSummaryCurrent, selectFetchingRecord, selectGroups, selectPersonConfig, selectMyWorksFileTreeExplorer } from '../store.js';
...
class Container extends Component {
	  componentDidMount() {
	      const {getPageLangs, langCode, getMyWorks, getWorksSharedWithMe, personId} = this.props;
				getMyWorks(personId);
