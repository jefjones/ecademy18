...
// import {image64toCanvasRef, extractImageFileExtensionFromBase64, base64StringtoFile} from '../../utils/javascriptUtils.js';
...
render() {
      const {handleClose, title, handleInputFile, file, submitFileUpload, handleCancelFile} = this.props;
