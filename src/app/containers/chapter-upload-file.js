...
import { selectMe, selectLanguageList, selectWorkSummaryCurrent, selectChapterIdCurrent, selectTextProcessingProgress } from '../store.js';
...
class Container extends Component {
  ...
  render() {
      return <WorkUploadFileView {...this.props} />
  }
}
