...
import * as fromContributorReport from '../reducers/contributor-report.js';
import * as fromReportFilterOptions from '../reducers/report-filter-options.js';
import * as actionPageLang from '../actions/language-list';
import { selectMe, selectContributorReport, selectReportFilter } from '../store.js';
...
class Container extends Component {
  componentDidMount() {
      const {personId, getPageLangs, langCode, initContributorReport, initReportFilter, initReportFilterOptions} = this.props;
  ...
  render() {
      ...
      return <ContributorReportView {...this.props} />
  }
}
