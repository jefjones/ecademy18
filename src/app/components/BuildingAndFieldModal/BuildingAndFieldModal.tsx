...
function BuildingAndFieldModal(props) {
  const {onClick, onDelete, handleClose, className, record, recordType, handleChange, toggleCheckbox, mapDirections, levelEntrances=[]} = props
...
export default BuildingAndFieldModal
