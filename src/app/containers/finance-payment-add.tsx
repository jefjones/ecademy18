...
import { selectMe, selectFinanceBillings, selectFinanceFeeTypes, selectCompanyConfig, selectAccessRoles, selectMyFrequentPlaces, selectGuardians,
					selectFetchingRecord, selectStudents, selectFinancePaymentTypes, selectFinanceAccountSummaries } from '../store'
...
function Container(ownProps) {
  ...
  useEffect(() => {
        	...
        	const {getPageLangs, langCode, personId, setMyVisitedPage, getGuardians, getFinanceBillings, getFinanceFeeTypes, getFinancePaymentTypes, getFinanceAccountSummaries } = props
  ...
  return <FinancePaymentAddView {...props} />
}
