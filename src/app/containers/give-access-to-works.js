...
import { selectWorkSummaryCurrent, selectWorkSummary, selectMe, selectWorkFilter, selectPersonIdCurrent,
            selectLanguageList, selectFetchingRecord, selectEditorInvitePending, selectPersonConfig } from '../store.js';
...
class Container extends Component {
  ...
  componentDidMount() {
      const {getPageLangs, langCode, init, personId} = this.props;
      init(personId);
  ...
  render() {
      ...
      return <GiveAccessToWorksView {...this.props} />
  }
}
