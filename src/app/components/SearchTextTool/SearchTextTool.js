...
export default class SearchTextTools extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        let {className="", pointer, totalCount, jumpToSearch, submitSearchText, setEditOptionTools, hideLeftArrow} = this.props;
