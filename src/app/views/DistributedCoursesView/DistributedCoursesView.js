...
class DistributedCoursesView extends Component {
    ...
    render() {
      const {personId, distributedCourses, fetchingRecord, students, personConfig={}, activateDistributedCourses } = this.props;
      const {partialNameText, studentIdList, selectedGradeLevels} = this.state;
