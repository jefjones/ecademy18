...
import { selectUsers, selectMe, selectCoursesScheduled, selectLearnerOutcomes, selectCompanyConfig, selectClassPeriods, selectPersonConfig,
					...
					selectColleges, selectStandardsRating } from '../store.js';
...
class Container extends Component {
		...
		componentDidMount() {
				const {getPageLangs, langCode, personId, params, setMyVisitedPage, getContentTypes, getCourseTypes, getClassPeriods, gradeScaleInit, getStandardsRating, getCourseDaysScheduled} = this.props;
        ...
        getStandardsRating(personId);
				...
				this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Course Section Entry`});
		}

	  render() {
				return <CourseToScheduleView {...this.props} />
	  }
}
