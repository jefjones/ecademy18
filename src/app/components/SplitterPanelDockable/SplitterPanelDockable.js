...
class SplitterPanelDockable extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const {newSections, leftSidePanelOpen, splitChapter, workSummary, deleteSectionByName} = this.props;
...
SplitterPanelDockable.propTypes = {
...
SplitterPanelDockable.defaultProps = {
  docked: false,
  open: false,
  transitions: true,
  touch: true,
