...
import { selectMe, selectRegistration, selectGender, selectCountries, selectUSStates, selectGradeLevels, selectLanguageList, selectPersonConfig,
 					selectHowLearnOfUsList, selectRegistrationCourses, selectIntervals, selectCompanyConfig} from '../store.js';
...
class Container extends Component {
		componentDidMount() {
				const {getPageLangs, langCode, personId, setMyVisitedPage, getCountries, getUSStates, getGender, getMaritalStatus, getGradeLevels, getLanguageList, getHowLearnOfUs,
								getIntervals, getRegistrationCourses} = this.props;
        ...
        this.props.location && this.props.location.pathname && setMyVisitedPage(personId, {path: this.props.location.pathname, description: `Add or Edit Student Registration`});
		}

	  render() {
	    	return <RegStudentView {...this.props} />;
	  }
}
